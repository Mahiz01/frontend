...
const api = " http://localhost:5000/api/employee/getEmployee"
...
const navigate = useNavigate();
    useEffect(() => {
      ...
      const deleteEmp= async(eid)=>{
            try{
                // incase u need real time deletion
                // const empDeleteApi = " "+eid;
                // const res = await axios.delete(empDeleteApi+eid);
                // console.log(res);
                let data = [...emp].filter((e)=>e._id!==eid)
                setEmp(data);
                console.log(data)
            }
            catch(e){
                        ...
                        <tbody>
                            {
                                emp.map((e,index)=>(
                                    ...
                                    <td style={{ "width": "15%" }}>
                                        <span>
                                            <NavLink to='/admin/employee/update' state={{empDetails:e}}>
                                            <svg 
                                        ...
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="#" onClick={()=>deleteEmp(e._id)}>
...
{/* <nav aria-label="Page navigation example">
        ...
        {page==total_pages?<li className="page-item disabled">
